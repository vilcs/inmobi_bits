...
const update_shoppingcart_dto_1 = require("./dto/update-shoppingcart.dto");
let ShoppingcartController = class ShoppingcartController {
    ...
    update(id, updateShoppingcartDto) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_shoppingcart_dto_1.UpdateShoppingcartDto]),
    __metadata("design:returntype", void 0)
